...
// N_min is the number that identify the first data, then 34 more data are added see line 1059
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
void L1plusL2(Juu_type *Juu1, ww_type *ww_con1, ww_type *ww_dis1, params *p1, Juu_type *Juu2, ww_type *ww_con2, ww_type *ww_dis2, params *p2,Juu_type *JuuTemp, ww_type *ww_conTemp, ww_type *ww_disTemp, params *pTemp, int degree){
  ...
  int norm_probAA=0,norm_probAB=0,norm_probBA=0,check_triplet1=0,check_triplet2=0,n_triplet=0,n_couple_con=0,n_couple_dis=0,num_ABinB=0,num_BAinB=0,norm_prob_con=0;
  double A=0,B=0,C=0,D=0,J1=0,J2=0,u1=0,u2=0,ut1=0,ut2=0,h=0,probJ_old1=0,prob_con_old1=0,probJ_old2=0,prob_con_old2=0;
...
int main(int argc, char *argv[]) {
  ...
  FILE *f;
  char s[90];
  Juu_type *JuuL,*Juu2L,*JuuTemp1,*JuuTemp2;
  ww_type *ww_conL,*ww_disL,*ww_con2L,*ww_dis2L,*ww_conTemp1,*ww_disTemp1,*ww_conTemp2,*ww_disTemp2; 
  params paramsL,params2L, paramsTemp1, paramsTemp2;
  ...
  for(n=N_min;n<N_max;n++){
    sprintf(s,"dati_2point_disc_LLLL_new/disc_LLLL_new_%d.dat",n);
    f=fopen(s,"w");
    ...
    for(LMAX=2; LMAX<15; LMAX++){
      ...
      loop_distribution(JuuL,ww_conL,ww_disL,&paramsL,JuuL,ww_conL,ww_disL,&paramsL,JuuTemp1,ww_conTemp1,ww_disTemp1,&paramsTemp1);

      L1plusL2(JuuTemp1,ww_conTemp1,ww_disTemp1,&paramsTemp1,Juu2L,ww_con2L,ww_dis2L,&params2L,JuuTemp1,ww_conTemp1,ww_disTemp1,&paramsTemp1,3);
      
      L1plusL2(Juu2L,ww_con2L,ww_dis2L,&params2L,JuuL,ww_conL,ww_disL,&paramsL,JuuTemp2,ww_conTemp2,ww_disTemp2,&paramsTemp2,2);
    

      fprintf(f,"%d %g\n",LMAX, - paramsTemp1.probJ + 2* paramsTemp2.probJ);
      fflush(f);
